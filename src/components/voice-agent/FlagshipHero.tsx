        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/50 border border-purple-500/30 rounded-full mb-8">
              ...
              <span className="text-sm text-purple-400 font-medium">Flagship Product</span>
            </div>
          ...
          >
            <button
              onClick={onBookDemo}
              className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-500 to-violet-600 text-white font-semibold rounded-lg hover:from-purple-400 hover:to-violet-500 transition-all duration-300 shadow-lg hover:shadow-purple-500/50 hover:scale-105"
            >
              Book a Live Demo
            ...
            <button
              onClick={onSeeDemo}
              className="group inline-flex items-center gap-3 px-8 py-4 bg-slate-800/50 border-2 border-slate-600 text-white font-semibold rounded-lg hover:bg-slate-700/50 hover:border-purple-500 transition-all duration-300"
            >
