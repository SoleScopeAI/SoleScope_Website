      ...
      <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="relative min-h-[600px] flex items-center justify-center">
            ...
            >
              <div className="relative">
                ...
                <div className="relative p-10 bg-gradient-to-br from-purple-500 to-violet-600 rounded-3xl shadow-2xl">
                  <PhoneCall className="w-14 h-14 text-white" />
                </div>
              </div>
              <div className="text-center mt-4 min-w-[200px]">
                <div className="text-xl font-bold text-white whitespace-nowrap">AI Voice Agent</div>
                <div className="text-purple-400 font-semibold text-sm">The Front Door</div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col items-center">
                <div className="p-5 bg-slate-800 border-2 border-purple-500/50 rounded-xl">
                  <BarChart3 className="w-9 h-9 text-purple-400" />
                </div>
                <div className="text-center mt-2 min-w-[120px]">
                  <div className="text-base font-bold text-white whitespace-nowrap">Dashboard</div>
                  <div className="text-xs text-slate-400">Command Centre</div>
                </div>
                <ArrowRight className="w-5 h-5 text-purple-400 rotate-90 my-2" />
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="p-5 bg-slate-800 border-2 border-violet-500/50 rounded-xl">
                  <Globe className="w-9 h-9 text-violet-400" />
                </div>
              </div>
              <div className="text-center mt-2 min-w-[120px]">
                <div className="text-base font-bold text-white whitespace-nowrap">Website</div>
                <div className="text-xs text-slate-400">Digital Presence</div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                <div className="p-5 bg-slate-800 border-2 border-slate-500/50 rounded-xl">
                  <Zap className="w-9 h-9 text-slate-400" />
                </div>
                <ArrowRight className="w-5 h-5 text-purple-400 rotate-180 mx-3" />
              </div>
              <div className="text-center mt-2 min-w-[120px]">
                <div className="text-base font-bold text-white whitespace-nowrap">Automation</div>
            ...
            >
              <div className="flex flex-col items-center">
                <ArrowRight className="w-5 h-5 text-purple-400 rotate-[135deg] mb-2" />
                <div className="p-5 bg-slate-800 border-2 border-purple-500/50 rounded-xl">
                  <TrendingUp className="w-9 h-9 text-purple-400" />
                </div>
                <div className="text-center mt-2 min-w-[120px]">
                  <div className="text-base font-bold text-white whitespace-nowrap">Growth</div>
                  <div className="text-xs text-slate-400">SEO & Marketing</div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className="grid md:grid-cols-2 gap-5">
            <div className="p-5 bg-slate-800/50 border border-purple-500/30 rounded-xl">
            ...
            <div className="p-5 bg-slate-800/50 border border-slate-500/30 rounded-xl">
        ...
        <motion.div
          ...
          className="mt-8 max-w-3xl mx-auto p-6 bg-gradient-to-r from-purple-500/10 to-violet-500/10 border border-purple-500/30 rounded-xl text-center"
        >
