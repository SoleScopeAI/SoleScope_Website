        ...
        >
          ...
          >
            <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600/30 via-purple-500/20 to-cyan-500/30 blur-3xl -z-10 scale-110"></div>

              {/* Main Hero Image */}
              <motion.img
                src="/Photo_Hero_Mobile.png"
                alt="Human hand reaching toward AI brain - representing the fusion of human creativity and artificial intelligence"
