          ...
          >
            <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl rounded-3xl border border-white/10 p-6 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  {[
                    ...
                    >
                      ...
                      <div className="text-[9px] text-purple-400">{metric.subtext}</div>
                    </motion.div>
                  ))}
                </div>
                  ...
                  {[
                    ...
                    <div key={idx}>
                      <div className="flex items-center justify-between mb-2">
                        <label className="text-xs font-medium text-white">{slider.label}</label>
                        <span className="text-xs text-purple-400 font-semibold">{slider.value}%</span>
                      </div>
                      <input
                        type="range"
                        min="0"
                ...
                <motion.div
                  className="mt-6 flex items-center justify-center gap-2 p-3 bg-purple-500/20 rounded-lg border border-purple-500/30"
                  animate={{
                    boxShadow: [
